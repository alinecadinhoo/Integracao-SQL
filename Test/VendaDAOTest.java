...
public class VendaDAOTest {
    ...
    public void init() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        cadastrarEstoque(this.produto, 10);
    }
    ...
    public void end() throws DAOException {
        ...
        estoqueDAO.excluir(this.produto.getCodigo());
    }
    ...
    private void excluirProdutos() throws DAOException {
        ...
        for (Produto prod : list) {
            this.produtoDao.excluir(String.valueOf(prod.getCodigo()));
        }
    }
    ...
    public void adicionarMaisProdutosDoMesmo() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        Estoque estoque = estoqueDAO.consultar(produto.getCodigo());
    ...
    public void adicionarMaisProdutosDiferentes() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        Estoque estoque = estoqueDAO.consultar(produto.getCodigo());
        estoque.setQuantidade(BigDecimal.valueOf(0));
    ...
    public void removerProduto() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        Estoque estoque = estoqueDAO.consultar(prod.getCodigo());
        assertNotNull(estoque);
    }
    ...
    private Estoque cadastrarEstoque(Produto produto, int quantidade) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        Estoque estoque = new Estoque();
        estoque.setCodigo(String.valueOf(produto.getCodigo()));
